...
class NoSSL
{
    ...
    /**
     * @param string $nossl_rsa_privatekey
     */
    ...
    public function decrypt($package)
    {
        ...
        if (strpos($package, '@NoSSL_Package_begin@') === false) {
            echo "This is not a valid NoSSL message";
            return false;
        } //If this is not a valid package
     ...
     * @param $ref
     */
    public function decryptForm(&$ref)
    { //&$ref stands for either POST or GET
        global $nossl;
    ...
    {
        if (strpos($string, '@NoSSL_MessageKey_begin@') === false) {
            return false;
        }
    ...
    {
        if (strpos($string, '@NoSSL_RSAKey_begin@') === false) {
            return false;
        }
    ...
    {
        if (strpos($string, '@NoSSL_ETR_begin@') === false) {
            return false;
        }
    ...
    public function decryptRSA($encryptedstring, $privatekey)
    {
        ...
        $returnValue = $this->rsa->decrypt($encryptedstring);
        return $returnValue;
    }
