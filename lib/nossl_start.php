...
if (!file_exists(__DIR__ . '/../config/RSA_privatekey.php') || !file_exists(__DIR__ . '/../config/RSA_publickey.php')) {
...
require_once(__DIR__ . '/../config/RSA_privatekey.php');
require_once(__DIR__ . '/../config/RSA_publickey.php');
session_name('nossl');
session_start();
